...
void display() {
    ...
    glutSolidSphere(8, 10, 10); // Actual radius of the sun is ~0.5M km. We are drawing it 10 times larger to see it.
    ...
    float mercuryOrbit = 87.969/365.256;
    glPushMatrix();
        glRotatef(mercuryOrbit*time/100, 0.0, 0.0, 1.0);
        glTranslatef(0, 57.909, 0);
    ...
    float venusOrbit = 224.701/365.256;
    glPushMatrix();
        glRotatef(venusOrbit*time/100, 0.0, 0.0, 1.0);
        glTranslatef(0, 108.208, 0);
    ...
    glPushMatrix();
        glRotatef(time/100, 0.0, 0.0, 1.0);
        glTranslatef(0, 149.598, 0);
        glColor3f(0.0, 1.0, 0.0);
        glutSolidSphere(4.0, 10, 10);

        glColor3f(1, 1, 1);
        glutWireTorus(0.01, 384399E-4/3, 2, 100);  // Moon orbit
        float moonOrbit = 27.322/365.256;
        glPushMatrix();
            glRotatef(moonOrbit*time/100, 0.0, 0.0, 1.0);
            glTranslatef(0, 384399E-4/3, 0);
